...
An interactive CLI agent with read, write, and shell tools.
Demonstrates autonomous multi-step behavior: read -> reason -> write.
"""
...
def main() -> None:
    ...
    print("Multi-Step Agent (type 'quit' to exit)")
    print("-" * 40)
    print("Available tools:", ", ".join(sorted(TOOL_HANDLERS.keys())))
    print("Try: Read 01_chat_loop.py, suggest a fix, and write it to fixed_chat_loop.py")
